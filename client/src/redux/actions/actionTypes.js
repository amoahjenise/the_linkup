...
export const ADD_LINKUP = "ADD_LINKUP";
export const REMOVE_LINKUP = "REMOVE_LINKUP";
...
export const UPDATE_LINKUP = "UPDATE_LINKUP";
export const MARK_LINKUPS_AS_EXPIRED_SUCCESS =
  "MARK_LINKUPS_AS_EXPIRED_SUCCESS";
export const SHOW_UPDATE_FEED_BUTTON = "SHOW_UPDATE_FEED_BUTTON";
export const MERGE_LINKUPS_SUCCESS = "MERGE_LINKUPS_SUCCESS";
...
export const SET_IS_IN_CONVERSATION = "SET_IS_IN_CONVERSATION";
